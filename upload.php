...
if(isset($_POST["submit"]) && !empty($_FILES["file"]["name"]))
{
    ...
    if(in_array($fileType, $allowTypes))
    {
        ...
        {
            $insert = "INSERT INTO tb_filecode(file_name,upload_on) VALUES ('$targetFilePath',NOW())";
    ...
    {
        $statusMsg = 'Sorry, only JPG, JPEG, PNG, GIF, TXT, BMP & PDF files are allowed to upload.';
    }
}
else
{
...
<input type="submit" value="Generate Bar Code" name="submit"/>
</form>
</body>
</html>